========================================================================
    APPLICAZIONE WIN32: cenni preliminari sul progetto Server
========================================================================

La creazione guidata applicazione ha creato questa applicazione Server.
...
Server.ico
    File di icona utilizzato come icona dell'applicazione (32x32). Tale icona è inclusa dal file di risorse principale Server.rc.

small.ico
    File di icona contenente una versione di dimensioni inferiori (16x16) dell'icona dell'applicazione. Tale icona è inclusa dal file di risorse principale Server.rc.

/////////////////////////////////////////////////////////////////////////////
Altri file standard:

StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato Server.pch e il file dei tipi precompilato StdAfx.obj.
